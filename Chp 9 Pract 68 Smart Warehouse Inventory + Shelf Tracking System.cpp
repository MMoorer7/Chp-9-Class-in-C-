...
public:
    ...
    void add_stock(int row, int col, int units)
    {
        ...
        total_units_in_warehouse = total_units_in_warehouse + units;
    ...
    void ship_stock(int row, int col, int units, int day_number)
    {
        ...
        shelf_units[row][col] = shelf_units[row][col] - units;
        total_units_in_warehouse = total_units_in_warehouse - units;
        shipped_units_per_day[day_number - 1] = shipped_units_per_day[day_number - 1] + units;
    ...
    void display_weekly_shipping_report()
    {
        ...
        for (int day_index = 0; day_index < 7; day_index++)
        {
            ...
            total_shipped = total_shipped + shipped_units_per_day[day_index];
        }
